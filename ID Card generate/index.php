...
<head>
  ...
  <title>Identity Card Generate</title>
...
<nav>
    <div class="nav-wrapper">
      <a href="./index.php" class="brand-logo"><img src="./assets/images/gIET LOGO2.png" alt="Logo"></a>
            <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
            <span id="name">GIET</span>
            <ul class="right hide-on-med-and-down">
                <li><a href="./index.php">Home</a></li>
                <li><a href="https://www.giet.edu/about-giet/">About</a></li>
